...
layers = [
    ...
    convolution2dLayer(9, 128, 'Padding', 4)
    batchNormalizationLayer
    reluLayer
    convolution2dLayer(7, 128, 'Padding', 4, 'NumChannels', 128)
    batchNormalizationLayer
    reluLayer
    convolution2dLayer(5, 64, 'Padding', 2, 'NumChannels', 128)
    batchNormalizationLayer
    reluLayer
    convolution2dLayer(5, 64, 'Padding', 2, 'NumChannels', 64)
    batchNormalizationLayer
    reluLayer
    convolution2dLayer(5, 32, 'Padding', 1, 'NumChannels', 64)
    batchNormalizationLayer
    reluLayer
    convolution2dLayer(3, 1, 'Padding', 1, 'NumChannels', 32)
    regressionLayer
];
